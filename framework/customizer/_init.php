 ...
 */
function times_customize_register( $wp_customize ) {
	$wp_customize->get_setting( 'blogname' )->transport         = 'postMessage';
	$wp_customize->get_setting( 'blogdescription' )->transport  = 'postMessage';		
	$wp_customize->get_section( 'title_tagline')->title = __( 'Title, Tagline & Logo', 'times' );
	
	$wp_customize->add_panel( 'times_a_fcp_panel', array(
	    'priority'       => 40,
...
add_action( 'customize_register', 'times_customize_register' );
 ...
 */
function times_customize_preview_js() {
	wp_enqueue_script( 'times_customizer', get_template_directory_uri() . '/assets/js/customizer.js', array( 'customize-preview' ), '20130508', true );
}
add_action( 'customize_preview_init', 'times_customize_preview_js' );
