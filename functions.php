...
function times_setup() {
	 ...
	 * If you're building a theme based on times, use a find and replace
	 * to change 'times' to the name of your theme in all the template files
	 */
	...
	add_image_size('times-sq-thumb', 600,600, true );
	add_image_size('times-thumb', 540,450, true );
	add_image_size('times-pop-thumb',542, 340, true );
...
function times_scripts() {
	...
	wp_enqueue_style('times-title-font', '//fonts.googleapis.com/css?family='.str_replace(" ", "+", get_theme_mod('times_title_font', 'Lato') ).':100,300,400,700' );
	
	wp_enqueue_style('times-body-font', '//fonts.googleapis.com/css?family='.str_replace(" ", "+", get_theme_mod('times_body_font', 'Open Sans') ).':100,300,400,700' );
	...
	wp_enqueue_style( 'times-main-theme-style', get_template_directory_uri() . '/assets/theme_styles/css/'.get_theme_mod('times_skin', 'default').'.css', array(), null );

	wp_enqueue_script( 'times-navigation', get_template_directory_uri() . '/assets/js/navigation.js', array(), '20120206', true );
	
	wp_enqueue_script( 'times-externaljs', get_template_directory_uri() . '/assets/js/external.js', array('jquery'), '20120206', true );
	...
	wp_enqueue_script( 'times-custom-js', get_template_directory_uri() . '/assets/js/custom.js', array('times-externaljs') );
}
